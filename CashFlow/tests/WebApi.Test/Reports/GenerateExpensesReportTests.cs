...
public class GenerateExpensesReportTests : CashFlowClassFixture
{
    ...
    public GenerateExpensesReportTests(CustomWebApplicationFactory webApplicationFactory) : base(webApplicationFactory)
    {
